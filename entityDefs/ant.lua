...
function ant.client:setState(state)
...
function ant.client:lerpState(a, b, t)
    local state = {}
...
function ant.client:draw()
    ...
    and wmy > vy - img:getHeight() and wmy < vy then
        ...
        local name = string.format('Ant [Level %i]', self.level)
